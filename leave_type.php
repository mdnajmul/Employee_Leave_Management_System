                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td> <span class="name"><?php echo $row['type']?></span></td>
                                                            <td>
                                                                <span class="badge badge-warning"><a href="add_leave_type.php?id=<?php echo $row['id']?>">Edit</a></span> <span class="badge badge-danger"><a href="leave_type.php?id=<?php echo $row['id']?>&type=delete">Delete</a></span>
                                                            </td>
                                                        </tr>
                                                <?php } ?>
                                            </tbody>
